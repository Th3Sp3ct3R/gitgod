...
scraped_at: 2026-04-14T16:09:20.311Z
method: markitdown
---
Search
...
* [Base Slug Matching](#base-slug-matching)
* [Example: Targeting a specific endpoint variant](#example-targeting-a-specific-endpoint-variant)
...
| --- | --- | --- | --- |
| `order` | string[] | - | List of provider slugs to try in order (e.g. `["anthropic", "openai"]`). [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#ordering-specific-providers) |
| `allow_fallbacks` | boolean | `true` | Whether to allow backup providers when the primary is unavailable. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#disabling-fallbacks) |
| `require_parameters` | boolean | `false` | Only use providers that support all parameters in your request. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#requiring-providers-to-support-all-parameters-beta) |
| `data_collection` | ”allow” | “deny" | "allow” | Control whether to use providers that may store data. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#requiring-providers-to-comply-with-data-policies) |
| `zdr` | boolean | - | Restrict routing to only ZDR (Zero Data Retention) endpoints. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#zero-data-retention-enforcement) |
| `enforce_distillable_text` | boolean | - | Restrict routing to only models that allow text distillation. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#distillable-text-enforcement) |
| `only` | string[] | - | List of provider slugs to allow for this request. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#allowing-only-specific-providers) |
| `ignore` | string[] | - | List of provider slugs to skip for this request. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#ignoring-providers) |
| `quantizations` | string[] | - | List of quantization levels to filter by (e.g. `["int4", "int8"]`). [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#quantization) |
| `sort` | string | object | - | Sort providers by price, throughput, or latency. Can be a string (e.g. `"price"`) or an object with `by` and `partition` fields. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#provider-sorting) |
| `preferred_min_throughput` | number | object | - | Preferred minimum throughput (tokens/sec). Can be a number or an object with percentile cutoffs (p50, p75, p90, p99). [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#performance-thresholds) |
| `preferred_max_latency` | number | object | - | Preferred maximum latency (seconds). Can be a number or an object with percentile cutoffs (p50, p75, p90, p99). [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#performance-thresholds) |
| `max_price` | object | - | The maximum pricing you want to pay for this request. [Learn more](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#maximum-price) |
...
including any variants like “/turbo”. See [Targeting Specific Provider Endpoints](/_/openrouter.ai/_/_/_/docs/guides/routing/provider-selection#targeting-specific-provider-endpoints) for details.
...
[Previous](/docs/guides/routing/model-fallbacks)[#### Auto Exacto

Automatic tool-calling provider optimization

Next](/docs/guides/routing/auto-exacto)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)
