...
scraped_at: 2026-04-14T16:09:46.403Z
method: markitdown
---
Search
...
* [Enabling Broadcast](#enabling-broadcast)
* [Supported Destinations](#supported-destinations)
* [Coming Soon](#coming-soon)
* [Trace Data](#trace-data)
* [Optional Trace Data](#optional-trace-data)
* [Custom Metadata](#custom-metadata)
* [Common Metadata Keys](#common-metadata-keys)
* [Linking to External Traces](#linking-to-external-traces)
* [Destination-Specific Metadata](#destination-specific-metadata)
* [API Key Filtering](#api-key-filtering)
...
[Previous](/docs/guides/features/input-output-logging)[#### Arize AI

Send traces to Arize AI

Next](/docs/guides/features/broadcast/arize)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)
