...
scraped_at: 2026-04-14T16:09:08.783Z
method: markitdown
---
Search
...
* [In the Chatroom](#in-the-chatroom)
* [API Usage](#api-usage)
* [Basic Image Generation](#basic-image-generation)
* [Image Configuration Options](#image-configuration-options)
* [Aspect Ratio](#aspect-ratio)
* [Image Size](#image-size)
* [Font Inputs (Sourceful only)](#font-inputs-sourceful-only)
* [Super Resolution References (Sourceful only)](#super-resolution-references-sourceful-only)
...
[Previous](/docs/guides/overview/multimodal/images)[#### PDF Inputs

How to send PDFs to OpenRouter models

Next](/docs/guides/overview/multimodal/pdfs)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)
