...
scraped_at: 2026-04-14T16:09:09.774Z
method: markitdown
---
Search
...
* [Pricing](#pricing)
* [Using PDF URLs](#using-pdf-urls)
* [Using Base64 Encoded PDFs](#using-base64-encoded-pdfs)
* [Skip Parsing Costs](#skip-parsing-costs)
* [File Annotations Schema](#file-annotations-schema)
...
[Previous](/docs/guides/overview/multimodal/image-generation)[#### Audio

How to send and receive audio with OpenRouter models

Next](/docs/guides/overview/multimodal/audio)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)
